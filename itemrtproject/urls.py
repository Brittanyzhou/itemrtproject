...
urlpatterns = patterns('',
    ...
    #manage programming question
    url(r'^prototype1/$', 'itemrtweb.views.prototype1'),
    #url(r'^prototype1/edit/question/(?P<question_id>\d+)/$', 'itemrtweb.views.prototype1b'),
    url(r'^prototype1/edit/question/(?P<question_id>\d+)/$', 'itemrtweb.views.prototype1a'),
    url(r'^prototype1/delete/question/(?P<question_id>\d+)/$', 'itemrtweb.views.prototype6'),
    url(r'^prototype1/preview1/question/(?P<question_id>\d+)/$', 'itemrtweb.views.preview1'),
    url(r'^prototype4/$', 'itemrtweb.views.prototype4'),
    url(r'^prototype4/list/topic/(?P<topic_id>\d+)/$', 'itemrtweb.views.prototype4'),
    url(r'^prototype4/list/tags/$', 'itemrtweb.views.prototype4a'),

    url(r'^programming_answer/$', 'itemrtweb.views.programming_answer'),
    url(r'^programming_answer_edit/$', 'itemrtweb.views.programming_answer_edit'),
    url(r'^programming_answer_edit1/$', 'itemrtweb.views.programming_answer_edit'),
    url(r'^programming_answer/delete/answer/(?P<programcase_id>\d+)/$', 'itemrtweb.views.programming_answer_delete'),
    url(r'^prototype1a/$','itemrtweb.views.prototype1a'),
    #programming
    url(r'^programming/$', 'itemrtweb.views.programming'),
    url(r'^programming/list/topic/(?P<topic_id>\d+)/$', 'itemrtweb.views.programming'),
    url(r'^programming/long_question_view/question/(?P<question_id>\d+)/$', 'itemrtweb.views.long_question_view'),
    url(r'^programming/submit/(?P<question_id>\d+)/$', 'itemrtweb.views.programming_submit'),
    #url(r'^practice/(\d+)/$', programming_submit),
    # Temp
