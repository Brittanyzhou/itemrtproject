...
#EMAIL_HOST = 'smtp.e.ntu.edu.sg'
#EMAIL_HOST_USER = 'GZHOU002@e.ntu.edu.sg'
#EMAIL_HOST_PASSWORD = '19890824gy'
EMAIL_PORT = 587
EMAIL_USE_TLS = True

PROJECT_PATH = os.path.dirname(os.path.abspath(__file__))
CODE_ROOT = os.path.dirname(os.path.abspath('F:'))
COMPILER_PATH = os.path.dirname(os.path.abspath('C:/Program Files (x86)/Java/jdk1.8.0_40/bin/javac.exe'))
EXECUTER_PATH = os.path.dirname(os.path.abspath('C:/Program Files (x86)/Java/jdk1.8.0_40/bin/java.exe'))
# Sets the name of the project/website
# The default is the codename of this project (itemrtproject)
PROJECT_NAME = 'JAVA Language Knowledge Testing System'
